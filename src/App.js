      ...
      <div className="App">
        <header className="App-header">
          ...
          <div className="profile-box">
            ...
            <p className="small-text bold-text">
              I love learning new technologies, taking ownership of my work, and
              tackling projects that push me to grow as an engineer. I’m
              especially drawn to work that values quality, clear design, and
          ...
          <div>
            ...
            {/* GitHub Link Button */}
            <a
              href="https://github.com/wgolden117"
              target="_blank"
          ...
          <div ref={bioRef} className="bio-section">
            ...
            <p className="small-text bold-text">
              I first attended Arizona State University (ASU) in the Fall of
              2016 after obtaining my Associate’s Degree from my local community
              college, the College of DuPage. I earned my Bachelor’s degree in
              Criminology and Criminal Justice, graduating Summa Cum Laude in
              2018.
            </p>

            <p className="small-text bold-text">
              During this time, I worked full-time while completing my
              Associate’s and Bachelor’s degrees, and for a period of time, I
              worked multiple jobs while attending school. Balancing work and
              academics taught me how to manage my time effectively, prioritize
              competing responsibilities, and understand how much work I can
              take on while still performing at a high level without burning
              out. These experiences helped me build strong self-discipline,
              adaptability, and a sustainable approach to long-term
              productivity.
            </p>

            <p className="small-text bold-text">
              After graduating, I continued working in accounts payable and
              later gained experience in human resources, customer service,
              reception, and sales. Working across different roles strengthened
              my communication skills, attention to detail, and ability to
              collaborate with people from a wide range of backgrounds.
            </p>

            <p className="small-text bold-text">
              I grew up in the suburbs of Chicago and lived there until my
              husband and I moved to Northern Utah. We lived there for about
              four years, and we now reside in Northern Idaho with our three
              beloved cats.
            </p>

            <p className="small-text bold-text">
              Throughout my professional career, I discovered a passion for
              programming and made the decision to return to school. I am
              thrilled to share that I graduated in May 2026 with my second
              Bachelor's degree in Software Engineering from ASU's Fulton
              Schools of Engineering — Summa Cum Laude with a 4.0 GPA. Now I'm
              diving headfirst into the most exciting work of my career. I'm
              currently interning as a Software Developer at METY Technology,
              contributing to a production AI-powered tutoring platform
              alongside a talented cross-functional team. At the same time, I'm
            ...
            <p className="small-text bold-text">
              Outside of work and academics, my hobbies include competitive
              shooting through the United States Practical Shooting Association
              (USPSA), snowboarding, playing the piano and violin, knitting, and
              gaming. I also love the outdoors and enjoy camping and hiking
              whenever I can. When I’ve had a long day, I unwind by relaxing
              with my favorite movies or shows and enjoying good food and
              snacks.
            </p>

            <p className="small-text bold-text">
              I hope you’ve enjoyed this About Me page as much as I enjoyed
              creating it. Thank you for taking the time to read a little about
              my life!
            </p>
          ...
          <section ref={photosRef} className="photo-gallery">
            ...
            <div className="photo-grid">
              ...
              <img
                src={photo5}
                alt="Snowboarding-Powder Mountain"
                className="clickable-image square-photo"
              />
              <img
                src={photo6}
                alt="Top of Sundown lift - Powder Mountain"
                className="clickable-image square-photo"
              />
              <img
                src={photo7}
              ...
              <img
                src={photo8}
                alt="Green Knit Sweater I made"
                className="clickable-image square-photo"
              />
              <img
                src={photo9}
                alt="Blue Purl Knit Crop-top Sweater I made"
                className="clickable-image square-photo"
              />
              <img
                src={photo10}
                alt="First attempt at cable stitch knitting!"
                className="clickable-image square-photo"
              />
              <img
                src={photo11}
                alt="Stargazing at the tetons"
                className="clickable-image square-photo"
              />
              <img
                src={photo12}
                alt="Cute little baby buffalo!"
                className="clickable-image square-photo"
              />
            </div>
            <button className="return-button" onClick={scrollToTop}>
